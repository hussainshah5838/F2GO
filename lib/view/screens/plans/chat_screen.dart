                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ChatBubble(
                              ...
                              myImg: dummyimage,
                              msg: msg.textMessage ?? "",
                              otherUserImg: msg.senderProfileImage.toString(),
                              //dummyImg,
                              ...
                              onImageTap: () {
                                log(msg.pictureMedia.toString());
                                Get.to(
                                  () => ViewProfileImage(
                                    imageSource: msg.pictureMedia.toString(),
                                  ),
                                );
                              },
                            );
...
//// --------------------------------------------------------------------------------------------
//// --------------------- AUTO SCRROL AT END WHEN KEY_BOARD OPENS ------------------------------
//// --------------------------------------------------------------------------------------------
...
//                         // ✅ AUTO SCROLL AFTER NEW MESSAGE IS BUILT
...
//               isLoading: controller.isLoading.value,
//               onAttachmentTap: () {
//                 Get.bottomSheet(const _MoreContent());
//               },
//               onSendTap: () async {
//                 final user = UserService.instance.userModel.value;

//                 if (!controller.isLoading.value &&
//                     controller.textMessageController.text.trim().isNotEmpty) {
//                   controller.messagesHandler(
//                     type: MsgType.text_msg.name,
//                     senderID: auth.currentUser?.uid ?? "",
//                     senderName: user.fullName.toString(),
//                     senderProfileImage: dummyImg,
//                     threadID: widget.chatHeadID,
//                     newMessage: controller.textMessageController.text.trim(),
//                   );
